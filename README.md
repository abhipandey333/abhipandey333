...
I'm a Full Stack Developer from India 🇮🇳 with 8+ years of experience building scalable web applications. Currently working as an Associate Consultant, Engineering at [GlobalLogic](https://www.globallogic.com/) (A Hitachi Group Company).

I specialize in **Laravel & Vue.js/Nuxt.js**, with hands-on production experience in **Node.js, NestJS, GraphQL, React.js/Next.js**, and have recently been building **AI agents using Google ADK**, real-time search with **Elasticsearch**, and chat integrations using the **WhatsApp Business API** and **Microsoft Teams API**.

### 🚀 Some things I've built

- **E-Learning Platform** — Migrated a YII-based LMS to Laravel and built a proctored online assessment feature for enterprise clients
- **Custom CRM System** — Designed an in-house CRM replacing Zoho, including GST-compliant invoicing and payment reconciliation
- **Food Delivery Platform** — Built [orderific.com](https://orderific.com) end to end, from concept through deployment
- **Affiliate & Coupons System** — Developed an affiliate-marketing web app and coupons management system with web UI + public API
- **AI Email Agents** — Built agents using Google ADK to automate reading and sending emails
...
<a href="" title="Nuxt.js" target="_blank" rel="noreferrer"><img src="https://www.vectorlogo.zone/logos/nuxtjs/nuxtjs-icon.svg" alt="Nuxt.js" width="30" height="30"/></a>&nbsp;&nbsp;
<a href="" title="React" target="_blank" rel="noreferrer"><img src="https://www.vectorlogo.zone/logos/reactjs/reactjs-icon.svg" alt="React" width="30" height="30"/></a>&nbsp;&nbsp;
...
<a href="" title="Elasticsearch" target="_blank" rel="noreferrer"><img src="https://www.vectorlogo.zone/logos/elastic/elastic-icon.svg" alt="Elasticsearch" width="30" height="30"/></a>&nbsp;&nbsp;
